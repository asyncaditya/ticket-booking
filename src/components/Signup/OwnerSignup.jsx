...
const OwnerSignup = () => {
  ...
  const signupHandler = () => {
    ...
    if (name1.length == 0) {
      ...
      axios.post('https://ticket-booking-dipanshuraghuwa.december-node-2022.repl.co/owner/signup', { data: data }, { headers: { "Content-Type": "application/json", } }).then((data) => {
          ...
          <div className="card px-4">
            <div className="card-body">
              <div className="mb-3 mt-md-4">
                <h2 className="fw-bold mb-2 text-center text-uppercase"> Owner Signup</h2>
                <div className="mb-3">
                  ...
                  <div className="mt-3 text-center">
                    <p className="mb-0">Already have an owner account?{' '}
